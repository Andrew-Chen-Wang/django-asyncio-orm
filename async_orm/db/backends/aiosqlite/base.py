...
from async_orm.db.backends.base.base import BaseAsyncDatabaseWrapper
from async_orm.db.backends.sqlite3.base import FORMAT_QMARK_REGEX
from async_orm.db.backends.sqlite3.base import DatabaseWrapper as SQLiteDatabaseWrapper
from async_orm.db.backends.sqlite3.base import decoder
        ...
        if self.features.supports_pragma_foreign_key_check:
            with await self.cursor() as cursor:
                if table_names is None:
                    violations = await cursor.execute(
